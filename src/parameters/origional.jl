const A_0 = 6          # Growth rate adjustment parameter
const α = 3.338e-5*24*10^6/(24*60*60)#3.75e-5 * 24 * 10^6 / (24 * 60 * 60) # photosynthetic efficiency 
...
const K_A = 0.6        # Structural dry weight per unit area
...
const N_min = 0.01     # Minimal nitrogen reserve
const N_max = 0.022    # Maximal nitrogen reserve
...
const N_struct = 0.01  # Amount of nitrogen per unit dry weight of structural mass
...
const K_X = 4          # Nitrate uptake half saturation constant, con1verted to mmol/m^3