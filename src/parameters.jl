...
alpha = 3.75e-5*24 # photosynthetic efficiency 
...
R_1 = 2.785e-4   # Respiration rate at T = TR1,
R_2 = 5.429e-4   # Respiration rate at T = TR2,
...
K_X = 4          # Nitrate uptake half saturation constant, converted to mmol/L
