...
alpha = 3.75e-5 * 24 *10^6 /(24*60*60) # photosynthetic efficiency 
...
I_sat = 200 *24*60*60 /(10^6)  # Irradiance for maximal photosynthesis
...
m_1 = 0.129#0.1085     # Growth rate adjustment parameter
m_2 = 0.036#0.03       # Growth rate adjustment parameter
